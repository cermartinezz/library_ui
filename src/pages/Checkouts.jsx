      ...
      <div className="flex flex-col border-2 rounded-md border-gray-500 p-4">
        <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">  
            <h2 className='font-bold mb-2'>My Books</h2>
                  ...
                  <tbody>
                      { checkouts.map((checkout,index) => 
                        ...
                        className="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-300">
                          <td scope="col" className="whitespace-nowrap px-6 py-4 font-medium">{checkout.copy.book.title}</td>
                          <td scope="col" className="whitespace-nowrap px-6 py-4 font-medium">{checkout.copy.publisher}</td>
                          <td scope="col" className="whitespace-nowrap px-6 py-4 font-medium">{checkout.copy.published_year}</td>
                          <td scope="col" className="whitespace-nowrap px-6 py-4 font-medium">{checkout.start_date}</td>
                          <td scope="col" className="whitespace-nowrap px-6 py-4 font-medium">{checkout.end_date}</td>
                          <td scope="col" 
